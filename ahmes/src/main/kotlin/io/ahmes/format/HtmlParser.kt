...
class HtmlParser : DocumentParser {
    ...
    private fun mergeByNamePreferFirst(
        first: List<io.ahmes.model.ExtendedFinancialMetric>,
        second: List<io.ahmes.model.ExtendedFinancialMetric>
    ): List<io.ahmes.model.ExtendedFinancialMetric> {
        val byName = mutableMapOf<String, io.ahmes.model.ExtendedFinancialMetric>()
