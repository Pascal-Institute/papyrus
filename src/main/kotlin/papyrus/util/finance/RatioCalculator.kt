...
object RatioCalculator {
        ...
        fun calculateRatios(
                ...
                if (revenue != null && netIncome != null && revenue != BigDecimal.ZERO) {
                        val value =
                                (netIncome.divide(revenue, 6, RoundingMode.HALF_UP)).multiply(
                                        BigDecimal("100")
                                )
                ...
                if (currentAssets != null &&
                        ...
                        val value =
                                currentAssets.divide(currentLiabilities, 6, RoundingMode.HALF_UP)
                        val valueDouble = value.toDouble()
                        calculated.add(
                                FinancialRatio(
                                        name = "Current Ratio",
                                        ...
                                        healthStatus =
                                                if (valueDouble > 1.5) HealthStatus.GOOD
                ...
                if (netIncome != null && totalEquity != null && totalEquity != BigDecimal.ZERO) {
                        val value =
                                (netIncome.divide(totalEquity, 6, RoundingMode.HALF_UP)).multiply(
                                        BigDecimal("100")
                                )
                        val valueDouble = value.toDouble()
                        calculated.add(
                ...
                if (revenue != null && totalAssets != null && totalAssets != BigDecimal.ZERO) {
                        ...
                        calculated.add(
                                FinancialRatio(
                                        ...
                                        healthStatus =
                                                HealthStatus
                                                        .NEUTRAL, // Hard to judge without industry
                                        // context
                ...
                if (revenue != null && operatingIncome != null && revenue != BigDecimal.ZERO) {
                        val value =
                                (operatingIncome.divide(revenue, 6, RoundingMode.HALF_UP)).multiply(
                                        BigDecimal("100")
                                )
                        val valueDouble = value.toDouble()
                        calculated.add(
                ...
                if (totalLiabilities != null &&
                        ...
                        calculated.add(
                                FinancialRatio(
                                        ...
                                        interpretation =
                                                if (valueDouble > 2.0) "High Leverage"
                                                else "Healthy Leverage",
                                        healthStatus =
                                                if (valueDouble > 2.0) HealthStatus.WARNING
