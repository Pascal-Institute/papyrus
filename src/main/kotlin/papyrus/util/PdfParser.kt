...
object PdfParser {
    ...
    private fun isFinancialStatementPage(text: String): Boolean {
        ...
        val keywords = listOf(
            ...
            "INCOME", "OPERATIONS", "CASH FLOWS", "ASSETS", 
            "LIABILITIES", "EQUITY", "REVENUE", "NET SALES"
        )
    ...
    private fun detectTableType(text: String): TableType {
        ...
        return when {
            upperText.contains("OPERATIONS") || upperText.contains("INCOME") && 
                !upperText.contains("COMPREHENSIVE") -> TableType.INCOME_STATEMENT
            upperText.contains("BALANCE") || upperText.contains("ASSETS") && 
                upperText.contains("LIABILITIES") -> TableType.BALANCE_SHEET
