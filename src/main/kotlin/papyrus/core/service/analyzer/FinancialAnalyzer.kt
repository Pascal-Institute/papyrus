...
object FinancialAnalyzer {
        ...
        suspend fun analyzeWithAI(
                ...
                val aiSummary =
                        try {
                                if (basicAnalysis.companyName != null &&
                                                basicAnalysis.reportType != null
                                ) {
                ...
                val industryComparison =
                        try {
                                if (basicAnalysis.ratios.isNotEmpty() &&
                                                basicAnalysis.companyName != null
                                ) {
                ...
                val investmentAdvice =
                        try {
                                if (basicAnalysis.healthScore != null &&
                                                basicAnalysis.companyName != null
                                ) {
        ...
        suspend fun reanalyzeWithAI(
                ...
                val aiSummary =
                        try {
                                if (existingAnalysis.companyName != null &&
                                                existingAnalysis.reportType != null
                                ) {
                                        AiAnalysisService.generateQuickSummary(
                                                companyName = existingAnalysis.companyName,
                ...
                val industryComparison =
                        try {
                                if (existingAnalysis.ratios.isNotEmpty() &&
                                                existingAnalysis.companyName != null
                                ) {
                                        AiAnalysisService.compareWithIndustry(
                                                companyName = existingAnalysis.companyName,
                                                ratios = existingAnalysis.ratios
                ...
                val investmentAdvice =
                        try {
                                if (existingAnalysis.healthScore != null &&
                                                existingAnalysis.companyName != null
                                ) {
                                        AiAnalysisService.generateInvestmentAdvice(
                                                companyName = existingAnalysis.companyName,
